    ...
    <nav className="bg-background border-b border-border">
      <div className="container mx-auto px-4">
        <div className="hidden lg:flex items-center justify-center py-6">
          ...
          <Link to="/" className="flex flex-col items-center mx-10">
            <img src={academyLogo} alt="Ahlei" className="h-24 w-24 mb-2" />
        ...
        <div className="lg:hidden flex items-center justify-between py-4">
          <Link to="/" className="flex items-center gap-3">
            <img src={academyLogo} alt="Ahlei" className="h-12 w-12" />
            <div>
